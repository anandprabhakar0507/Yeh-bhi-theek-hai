...
<html>
  ...
  <body style="background-image: url(https://i1.wp.com/dumaworks.com/blog/wp-content/uploads/2015/11/FB-Manager.jpg?ssl=1); background-attachment: fixed; background-size: cover">
...
<div class="container">
    <div class="jumbotron">
     <h1 style="color: white; text-align: center;">Manage your restaurant from here</h1>
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; color: white; text-align: center; font-size: 30px;"> YOUR FOOD ITEMS LIST </h3>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        <th>  </th>
        <th style="color: white"> Food ID </th>
        <th style="color: white"> Food Name </th>
        <th style="color: white"> Price </th>
        <th style="color: white"> Description </th>
        <th style="color: white"> Restaurant ID </th>
      </tr>
    </thead>
