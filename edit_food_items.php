...
<html>
  ...
  <body style="background-image: url(https://www.dominicancooking.com/wp-content/uploads/2008/09/tomate-tomato-DSC_9388.jpg); background-attachment: fixed; background-size: cover">
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    <div style="text-align: center;">
      <h3 style="color:black;"><u>Click On Menu</u> <br><br></h3>
    </div>
    <?php
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-danger pull-right" onclick="display_alert()" value="Display alert box" > Update </button>    
      </div>
        </form>
