...
<html>
  ...
  <body style="background-image: url(pi.jpg); background-attachment: fixed; background-size: cover">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-danger pull-right"> ADD FOOD </button>    
      </div>
        </form>
