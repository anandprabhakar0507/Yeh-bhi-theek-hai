...
?>
    ...
    <BR><BR><BR><BR>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: white;">Order Placed Successfully.&#9989;</h1>
          </div>
        </div>
        <br>

<h1 class="text-center" > Thank you for Ordering at Ratatouille.com! <br> The ordering process is now complete.</h2>
