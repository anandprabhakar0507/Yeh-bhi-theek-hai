...
<html>
  ...
  <body style="background-image: url(https://gray-kota-prod.cdn.arcpublishing.com/resizer/5jHNWDglPtp4xoB8oyoKamk2nR4=/1200x675/smart/cloudfront-us-east-1.images.arcpublishing.com/gray/FWTHX7LJQJJRXEGYCFNTJ6SFYY.jpg); background-attachment: fixed; background-size: cover">
...
<div class="container">
    <div class="jumbotron">
     <h1 style="color: white">Hello Manager! </h1>
     <p style="color: white">Manage all your restaurant from here<span style='font-size:35px;'>&#9989;</span></p>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-danger pull-right"> ADD RESTAURANT </button>    
      </div>
        </form>
