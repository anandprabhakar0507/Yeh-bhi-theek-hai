...
<html>
  ...
  <head>
    <title> Online Payment | Ratatouille.com </title>
  </head>
  ...
  <body style="background-image: url(cash.jpg); background-attachment: fixed; background-size: cover">
...
<div class="container">
    <div class="row">
        <div class="jumbotron">
          <h1 class="text-center" style="color: white">Online Payment&#x1f4b0;&#127974;</h1>
          <p class="text-center" style="color: white">Enter your payment details below.</p>
        </div>
    </div>
    <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="COD.php"><input type="submit" class="btn btn-danger btn-block" value="PAY NOW" required="" /></a>  
                            </div>
                        </div>
